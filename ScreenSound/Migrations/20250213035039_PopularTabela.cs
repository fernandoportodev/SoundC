...
namespace ScreenSound.Migrations
{
    ...
    public partial class PopularTabela : Migration
    {
        ...
        {
            migrationBuilder.InsertData("Artistas", new string[] { "Nome", "Bio", "FotoPerfil" }, new object[] { "Djavan", "Djavan (1949) é um cantor, compositor e arranjador brasileiro. Dono de uma enorme versatilidade musical, mescla inúmeros estilos que vão do jazz, ao blues, do samba à música flamenca.", "https://s.ebiografia.com/assets/img/authors/dj/av/djavan-l.jpg?auto_optimize=low&width=255" });
